package com.gxl.bluetooth.utils.iconview;
...
/**
 * author：guoxuliang on 2019/12/20 09:08
...
public class CircleTextImage extends ImageView {
    ...
    private boolean mUseRandomBackgroundColor = true;//Use random background color
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mUseRandomBackgroundColor = typedArray.getBoolean(R.styleable.circletextview_random_color, true);
    ...
    private void refreshTextSizeConfig() {
        mPaintTextForeground.setTextSize(textSizeRatio * 1 * 100);
