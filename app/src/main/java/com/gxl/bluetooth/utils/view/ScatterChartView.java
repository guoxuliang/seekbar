...
//    private Map<String, Integer> value = new HashMap<>();
    ...
    public ScatterChartView(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(getResources().getColor(R.color.xyColor));
...
//            //X轴文本最大高度
            ...
            float textXHeight = xValueRect.height()+300;
...
//            Log.i("==y:","==y:"+y+"==x:"+x);
            ...
            if(value.get(i)==120){
                ...
                canvas.drawCircle(x, 350f, dp7, linePaint);
                canvas.drawLine(x, yOri,x,350f,mPaint);
            }else {
                linePaint.setColor(getResources().getColor(R.color.titlecolorhf));
                linePaint.setStyle(Paint.Style.FILL_AND_STROKE);
                canvas.drawCircle(x, 600.71f, dp7, linePaint);
                canvas.drawLine(x, yOri,x,600.71f,mPaint);
            }
...
//                } else {
//                    canvas.drawText(text, 0, text.length(), x - rect.width() / 2, yOri + xylinewidth + dpToPx(2) + rect.height(), xyTextPaint);
                    drawText(canvas,text, x +10, 1160, xyTextPaint,-90);
//                }
            }
        }
    }
...
//    }
    ...
    public void setValue(List<Integer> value, List<String> xValue, List<Integer> yValue) {
        this.value = value;
        this.xValue = xValue;
        this.yValue = yValue;
        invalidate();
