 ...
 */
public class ScatterChartView2 extends View {
    //xy坐标轴颜色
    ...
    public ScatterChartView2(Context context) {
        this(context, null);
    }

    public ScatterChartView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScatterChartView2(Context context, AttributeSet attrs, int defStyleAttr) {
